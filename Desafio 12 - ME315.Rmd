...
-   Introduzir o uso de SQLite com Polars Explorar cálculos estatísticos em bancos de dados SQLite3
-   Realizar operações de agregação e filtragem usando SQL Lembrete: Os conhecimentos adquiridos com SQLite são diretamente aplicáveis a outros bancos de dados em SQL (MariaDB, MySQL, PostgreSQL).
